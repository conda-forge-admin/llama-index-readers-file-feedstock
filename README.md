...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/llama-index-readers-file-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/llama-index-readers-file-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add llama-index-readers-file
# for installing globally
pixi global install llama-index-readers-file
```
...
It is possible to list all of the versions of `llama-index-readers-file` available on your platform:
...
```
pixi search llama-index-readers-file --channel conda-forge
```
